...
class EventByNamePagingSource @AssistedInject constructor(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, EventDomainModel> {
        return try {
            ...
            val responseList = eventRepository.getEventsByTitle(page = page, title = title)
    ...
    @AssistedFactory
    interface Factory {
        fun create(@Assisted title : String) : EventByNamePagingSource
    }
}